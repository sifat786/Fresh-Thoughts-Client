...
const Footer = () => {
    return (
        <footer className="bg-purple-50 dark:bg-gray-900">
            <div className="md:px-14 py-8 mx-auto">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-wrap justify-center mt-6 -mx-4">
                        ...
                        <Link to={'/#blog'} className="mx-4 text-base font-medium text-gray-600 transition-colors duration-300 hover:text-red-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Recent Blog </Link>
                ...
                <div className="flex flex-col items-center md:flex-row md:justify-between">
                    <p className="text-base text-center md:text-left font-medium text-gray-500 dark:text-gray-300">© Copyright 2024. All Rights Reserved.</p>

                    <div className="flex -mx-2 mt-2 md:mt-0">
                        <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-red-500 dark:hover:text-blue-400" aria-label="Reddit">
                        ...
                        <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-red-500 dark:hover:text-blue-400" aria-label="Facebook">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-red-500 dark:hover:text-blue-400" aria-label="Github">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
